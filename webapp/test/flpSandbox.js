		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comempmodulezempmod1401-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comempmodulezempmod1401-display": {
								"semanticObject": "comempmodulezempmod1401",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.emp.module.zempmod1401",
									"url": sap.ui.require.toUrl("com/emp/module/zempmod1401")
								}
							}
						}
					}
